...
BOOL Preset_Settings() //Before Install, set default settings
{
    ...
    settings->sens = 20;
    settings->axis_int[THROTTLE][ONPRESS][END] = 300;
    settings->axis_int[THROTTLE][ONPRESS][MIDDLE] = 800;
    settings->axis_int[THROTTLE][ONPRESS][BEGIN] = 1000;
    settings->axis_int[THROTTLE][OFFPRESS][END] = 300;
    settings->axis_int[THROTTLE][OFFPRESS][MIDDLE] = 400;
    settings->axis_int[THROTTLE][OFFPRESS][BEGIN] = 300;
