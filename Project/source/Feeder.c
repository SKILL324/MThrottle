...
BOOL Preset_Settings() //Before Install, set default settings
{
    ...
    settings->sens = 20;
    settings->axis_int[THROTTLE][ONPRESS][END] = 1200;
    settings->axis_int[THROTTLE][ONPRESS][MIDDLE] = 600;
    settings->axis_int[THROTTLE][ONPRESS][BEGIN] = 300;
    settings->axis_int[THROTTLE][OFFPRESS][END] = 300;
    settings->axis_int[THROTTLE][OFFPRESS][MIDDLE] = 400;
    settings->axis_int[THROTTLE][OFFPRESS][BEGIN] = 400;
    settings->axis_int[BRAKE][ONPRESS][END] = 1200;
    settings->axis_int[BRAKE][ONPRESS][MIDDLE] = 800;
    settings->axis_int[BRAKE][ONPRESS][BEGIN] = 600;
    settings->axis_int[BRAKE][OFFPRESS][END] = 700;
    settings->axis_int[BRAKE][OFFPRESS][MIDDLE] = 800;
    settings->axis_int[BRAKE][OFFPRESS][BEGIN] = 1200;
    settings->axis_int[CLUTH][ONPRESS][END] = 3000;
    settings->axis_int[CLUTH][ONPRESS][MIDDLE] = 3000;
    settings->axis_int[CLUTH][ONPRESS][BEGIN] = 3000;
    settings->axis_int[CLUTH][OFFPRESS][END] = 3000;
    settings->axis_int[CLUTH][OFFPRESS][MIDDLE] = 3000;
    settings->axis_int[CLUTH][OFFPRESS][BEGIN] = 3000;
    settings->axis_int[HANDBRAKE][ONPRESS][END] = 3000;
    settings->axis_int[HANDBRAKE][ONPRESS][MIDDLE] = 3000;
    settings->axis_int[HANDBRAKE][ONPRESS][BEGIN] = 3000;
    settings->axis_int[HANDBRAKE][OFFPRESS][END] = 3000;
    settings->axis_int[HANDBRAKE][OFFPRESS][MIDDLE] = 3000;
    settings->axis_int[HANDBRAKE][OFFPRESS][BEGIN] = 3000;
...
inline LONG Steering()
{
    if (GetCursorPos(&Mousep1))
    {
        mousedelta = Mousep1.x - (LONG)(res.x / 2u);
        mousedelta *= (LONG)(settings->sens / 4);
        Steering_pos += mousedelta; //*settings->sens_mult;
